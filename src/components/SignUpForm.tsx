...
import { setSignUp } from "@/api123/Auth-User.API"
...
export const FormSchema = z.object({
  ...
  username: z.string().regex(/^[a-zA-Z0-9]{3,16}$/),
  email: z
    .string()
  ...
  dateOfBirth: z.date().refine((date) => {
    ...
    return todayYear - dateChoose >= 18;
  }, {
...
export function SignUpForm({
  ...
  const { mutate, isPending, } = useMutation({
    ...
    onMutate: () => {
      toast.loading("Signing Up...", { id: "toastIds" })
    }
  })
      ...
      <div className={cn("grid min-h-svh lg:grid-cols-2", className)} {...props}>
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Input type="password" placeholder="re-pass" {...field} />
                              </FormControl>
                              <FormMessage className="text-xs" />
                            </FormItem>
                          )}
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl>
                                <Select defaultOpen={false} onValueChange={field.onChange}   >
        ...
        <div className="bg-primary hidden lg:flex flex-col justify-center items-center text-white p-10">
          ...
          <p className="text-lg text-white/90 text-center max-w-md">
            Create your account and start sharing moments, ideas, and connections.
          </p>
        </div>
      </div>
    </>
